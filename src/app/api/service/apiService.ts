...
export default {
  ...
  */
  ...
  /**
   * @description [GET] get COVID-19 time series data for a specific country 
  */
  getV3Covid19HistoricalCountry: async (country: string, lastdays: number) => {
    return axios.get(`/v3/covid-19/historical/${country}?lastdays=${lastdays}`)
      .then((response) => response.data)
  }
}
